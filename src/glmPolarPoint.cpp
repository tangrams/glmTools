...
glmPolarPoint::glmPolarPoint(const float &_angle, const float &_radius):a(_angle),r(_radius),z(0.0){
}

glmPolarPoint::glmPolarPoint(const glm::vec3 &_org, const glm::vec3 &_dst):a(0.0),r(0.0),z(0.0){
